    ...
    <div class="row">
        <div class="col-sm-8">
            ...
            <p>For categorisation or prioritisation, <strong>stories</strong>
               ...
               <strong>worklists</strong>, which can themselves be
               assembled into <strong>boards</strong> for a clear overview
               of activity of interest to a project, a team, or a sponsor.</p>
            <p><a href="#!/board"
               target="_blank"
