...
angular.module('sb.project_group').controller('ProjectGroupDetailController',
    function ($scope, $rootScope, $stateParams, projectGroup, Story, Project,
        ...
        $rootScope.$on('$locationChangeSuccess', function() {
            localStorageService.cookie.set('Active', true);
            localStorageService.cookie.set('Merged', false);
            localStorageService.cookie.set('Invalid', false);
        });
        ...
        $scope.filterStories = function () {
            ...
            localStorageService.cookie.set('Active',
                $scope.filters.showActive);
            localStorageService.cookie.set('Merged',
                $scope.filters.showMerged);
            localStorageService.cookie.set('Invalid',
                $scope.filters.showInvalid);
